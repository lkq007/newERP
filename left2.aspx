...
insDoc(Class1, gLnk(1, '<a href=kehuxinxi_updt2.aspx target=main>个人资料管理</a>', '', 'images/editinfo.gif'));


Class2 = insFldr(foldersTree, gFldr('<DIV CLASS=fldrroot>订单信息管理</DIV>', ''));
insDoc(Class2, gLnk(1, '<a href=dingdanxinxi_add.aspx target=main>添加订单信息</a>', '', 'images/editinfo.gif'));
insDoc(Class2, gLnk(1, '<a href=dingdanxinxi_list2.aspx target=main>管理订单信息</a>', '', 'images/editinfo.gif'));
