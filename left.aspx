...
insDoc(Class1, gLnk(1, '<a href=edituser.aspx target=main>管理员帐号添加</a>', '', 'images/bianji.gif'));
insDoc(Class1, gLnk(1, '<a href=listuser.aspx target=main>管理员帐号查询</a>', '', 'images/bianji.gif'));
//insDoc(Class1, gLnk(1, '<a href=yonghuzhuce_list.aspx target=main>注册用户管理</a>', '', 'images/bianji.gif'));
...
insDoc(Class2, gLnk(1, '<a href=gongyingshangxinxi_add.aspx target=main>添加供应商</a>', '', 'images/bianji.gif'));
insDoc(Class2, gLnk(1, '<a href=gongyingshangxinxi_list.aspx target=main>管理供应商</a>', '', 'images/bianji.gif'));

Class2 = insFldr(foldersTree, gFldr('<DIV CLASS=fldrroot>订单管理</DIV>', ''));
insDoc(Class2, gLnk(1, '<a href=dingdanxinxi_list.aspx target=main>分配上游订单管理</a>', '', 'images/bianji.gif'));
insDoc(Class2, gLnk(1, '<a href=dingdanxinxi_list4.aspx target=main>分配下游订单管理</a>', '', 'images/bianji.gif'));
insDoc(Class2, gLnk(1, '<a href=dingdanxinxi_list6.aspx target=main>所有订单总额统计</a>', '', 'images/bianji.gif'));
Class2 = insFldr(foldersTree, gFldr('<DIV CLASS=fldrroot>仓库材料管理</DIV>', ''));
insDoc(Class2, gLnk(1, '<a href=cailiaoxuqiu_add.aspx target=main>材料需求登记</a>', '', 'images/bianji.gif'));
insDoc(Class2, gLnk(1, '<a href=cailiaoxuqiu_list.aspx target=main>库存查询</a>', '', 'images/bianji.gif'));
