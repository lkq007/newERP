   ...
   oDialog.focus();
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#1E90FF" cellPadding="4" width="100%" align="center" border="1">
				<tr bgColor="#B0C4DE">
					<td colSpan="2">
