<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dingdanxinxi_list5.aspx.cs" Inherits="dingdanxinxi_list5" %>
...
<body>
    ...
    <div>
        <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
            <tbody>
                <tr class="tr2">
                    <td bgcolor="#f1f8f5" style="padding-left: 5px; height: 25px">所有订单信息列表</td>
                </tr>
                <tr class="tr1">
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField=gongyingshang HeaderText='上游供应商'></asp:BoundColumn>
                                <asp:TemplateColumn HeaderText="完成任务"><ItemTemplate><%#DataBinder.Eval(Container.DataItem, "sywc")%></ItemTemplate><HeaderStyle Width="80px" /></asp:TemplateColumn>
                                <asp:BoundColumn DataField=gongyingshang2 HeaderText='下游供应商'></asp:BoundColumn>
                                <asp:TemplateColumn HeaderText="完成任务"><ItemTemplate><a href='sh3.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>&yuan=<%#DataBinder.Eval(Container.DataItem, "xywc")%>&tablename=dingdanxinxi' onclick="return confirm('确定要审核？')"><%#DataBinder.Eval(Container.DataItem, "xywc")%></a></ItemTemplate><HeaderStyle Width="80px" /></asp:TemplateColumn>

                                <%--<asp:TemplateColumn HeaderText="分配">
                               		<ItemTemplate>
                                    	<a href='dingdanxinxi_updt2.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>'>分配</a>
                                	</ItemTemplate>
								<HeaderStyle Width="50px" />
                                </asp:TemplateColumn>--%>
