<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gongyingshangxinxi_updt.aspx.cs" Inherits="gongyingshangxinxi_updt" %>
			...
			<br />
			   <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#1E90FF" style="border-collapse:collapse">
				...
				<tr><td noWrap width='30' style='WIDTH: 164px'>
                        ...
                        <FONT face='宋体'>编号:</FONT></td><td width='79%'><asp:textbox id='bianhao' disable runat='server' ReadOnly="true" style='border:solid 1px #000000; color:#666666'></asp:textbox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatorbianhao" runat="server" ControlToValidate="bianhao" ErrorMessage="必填"></asp:RequiredFieldValidator><tr><td noWrap width='30' style='WIDTH: 164px'>
