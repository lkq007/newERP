...
insDoc(Class1, gLnk(1, '<a href=gongyingshangxinxi_updt2.aspx target=main>个人资料管理</a>', '', 'images/editinfo.gif'));


Class2 = insFldr(foldersTree, gFldr('<DIV CLASS=fldrroot>订单任务管理</DIV>', ''));
insDoc(Class2, gLnk(1, '<a href=dingdanxinxi_list3.aspx target=main>订单任务管理</a>', '', 'images/editinfo.gif'));

Class2 = insFldr(foldersTree, gFldr('<DIV CLASS=fldrroot>材料供应查看</DIV>', ''));
insDoc(Class2, gLnk(1, '<a href=cailiaoxuqiu_list2.aspx target=main>材料供应查看</a>', '', 'images/editinfo.gif'));
...
//insDoc(Class2, gLnk(1, '<a href=fangjianxinxi_list2.aspx target=main>入住登记</a>', '', 'images/editinfo.gif'));
//insDoc(Class2, gLnk(1, '<a href=ruzhujilu_list.aspx target=main>入住查询</a>', '', 'images/editinfo.gif'));

//Class2 = insFldr(foldersTree, gFldr('<DIV CLASS=fldrroot>报损维修管理</DIV>', ''));
//insDoc(Class2, gLnk(1, '<a href=baosunweixiujilu_add.aspx target=main>报损维修登记</a>', '', 'images/editinfo.gif'));
//insDoc(Class2, gLnk(1, '<a href=baosunweixiujilu_list.aspx target=main>报损维修查询</a>', '', 'images/editinfo.gif'));
