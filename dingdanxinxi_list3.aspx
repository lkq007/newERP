<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dingdanxinxi_list3.aspx.cs" Inherits="dingdanxinxi_list3" %>
            ...
            <tbody>
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="完成任务"><ItemTemplate><a href='sh2.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>&yuan=<%#DataBinder.Eval(Container.DataItem, "sywc")%>&tablename=dingdanxinxi' onclick="return confirm('确定要审核？')"><%#DataBinder.Eval(Container.DataItem, "sywc")%></a></ItemTemplate><HeaderStyle Width="80px" /></asp:TemplateColumn>
